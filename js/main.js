...
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/fslightbox */ "./src/js/components/fslightbox.js");
...
/* harmony import */ var _components_video__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_video__WEBPACK_IMPORTED_MODULE_3__);
...
const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"]('tabs');
...
const prodactImage = document.querySelector(".prodact-card-images-slider");
const prodactImageThumbs = document.querySelector(".prodact-card-images-nav");
...
const aboutVideo = document.querySelector(".about-video-slider");
const aboutVideoThumbs = document.querySelector(".about-video-slider-nav");
const videoSliderNav = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](aboutVideoThumbs, {
  spaceBetween: 20,
  slidesPerView: 4,
  freeMode: true,
  watchSlidesProgress: true
});
const videoSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](aboutVideo, {
  spaceBetween: 30,
  slidesPerView: 1,
  navigation: {
    nextEl: ".swiper-button-next",
...
const videoBlockArr = document.querySelectorAll('.video-block');
videoBlockArr.forEach(videoBlock => {
  if (videoBlock) {
